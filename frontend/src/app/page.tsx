...
/** Force la regénération de la page à chaque requête (pas de cache statique) */
    ...
    return (
        <main>
            ...
            <section className="mx-auto max-w-6xl px-5 pt-10 pb-6 text-center md:pt-14 md:pb-10">
                ...
                <p className="mx-auto mt-3 text-sm text-dark-gray md:text-base">
                ...
                <div className="relative mt-8 h-72 overflow-hidden rounded-[10px] md:h-72 lg:h-80">
                    <Image
                        src="/img-landing.png"
                ...
                <div className="rounded-[10px] bg-white p-8 md:p-12">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
                        {STEPS.map((step) => (
                            <div
                                key={step.title}
                                className="rounded-[10px] bg-main-red p-8 md:p-10"
                            >
